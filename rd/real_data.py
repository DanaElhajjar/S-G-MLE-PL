...
def process_window(p, n, rank, argsMLEPL, tol, ifg_window):
    ...
    _, _, diag_w_past, _ = extractMLEfunc(X_past, 'Gaussian', 'Cor-Arg', rank, argsMLEPL)
    # S-MLE-PL approach on the dataset of the new image
    C_tilde_sequential, Sigma_tilde_sequential, new_phase_sequential = S_G_MLE_PL_BCD(X, X_past, x_newdata, C, diag_w_past, iter_max_BCD, phasecorrectionchoice, tol)
